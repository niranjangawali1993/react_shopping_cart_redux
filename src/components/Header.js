      ...
      <nav className='bg-white border-b-2 border-gray-200 dark:bg-gray-900 dark:border-b-1 dark:border-gray-900'>
        <div className='max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4'>
          <Link to='/' className='flex items-center'>
            <img
              src={logo}
              className='h-8  mr-3 lg:h-14 lg:w-14'
              alt='Shopping Cart'
            />
            <span className='self-center text-2xl font-semibold whitespace-nowrap dark:text-white md:text-xl'>
              Shopping Cart
            </span>
          </Link>
          <div className='flex md:order-2'>
            <div className='mx-4 md:text-center flex items-center hidden-sm'>
